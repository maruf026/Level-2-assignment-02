...
const createBooking = async (payload) => {
    ...
    const vehicle = await db_1.pool.query(`SELECT vehicle_name, daily_rent_price, availability_status FROM vehicles WHERE id = $1`, [vehicle_id]);
...
const getAllBooking = async (user) => {
    if (user.role === "admin") {
...
const updateBooking = async (status, bookingId) => {
